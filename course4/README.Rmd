---
title: "README_course4_project1"
author: "Beeta Masoumi"
date: "7/5/2019"
output: html_document
---
  This assignment uses data from the UC Irvine Machine Learning Repository,
  http://archive.ics.uci.edu/ml/index.php a popular repository for machine learning datasets.
  ...
  Dataset: Electric power consumption [20Mb] exdata_data_household_power_consumption.zip
  Description: Measurements of electric power consumption in one household with a one-minute
  sampling rate over a period of almost 4 years. Different electrical quantities and some s
  ub-metering values are available.
  ...
  exploratory graphs: "They help us find patterns in data and understand its properties.
  ...
  for legitimate differences in implementation styles, etc. Look for ways to give
  points when it's clear that the submitter has given a good faith effort to do
  ...
  is not to see if someone managed to match your way of doing things, but to see if
  ...
  We will only be using data from the dates 2007-02-01 and 2007-02-02. One alternative is
  to read the data from just those dates rather than reading in the entire dataset and subsetting
  to those dates.
  You may find it useful to convert the Date and Time variables to Date/Time classes in R
  using the \color{red}{\verb|strptime()|}strptime()  and \color{red}{\verb|as.Date()|}as.Date() functions.
  ...
  that constructs the corresponding plot, i.e. code in \color{red}{\verb|plot1.R|}plot1.R constructs
  the \color{red}{\verb|plot1.png|}plot1.png plot. Your code file should include code for reading
